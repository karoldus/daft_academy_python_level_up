...
def post_supplier(json_data: dict, db: Session, s_id: int):
    db.add(Supplier(CompanyName = json_data['CompanyName'],ContactName= json_data['ContactName'],ContactTitle= json_data['ContactTitle'],Address= json_data['Address'],City= json_data['City'],PostalCode= json_data['PostalCode'],Country= json_data['Country'],Phone= json_data['Phone'],Fax= None,HomePage= None))
    db.commit()
